            ...
            modelBuilder.Entity("Kolokwium2.Models.CharacterTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CharacterId = 1,
                            TitleId = 1,
                            AcquiredAt = new DateTime(2015, 12, 24, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            CharacterId = 3,
                            TitleId = 2,
                            AcquiredAt = new DateTime(2020, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("Kolokwium2.Models.Title", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Name = "Mielonkowy Krol"
                        });
                });

            modelBuilder.Entity("Kolokwium2.Models.Backpack", b =>
                {
                    b.HasOne("Kolokwium2.Models.Character", "CharacterNavigation")
                        .WithMany("Backpacks")
                        .HasForeignKey("CharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Kolokwium2.Models.Item", "ItemNavigation")
                        .WithMany("Backpacks")
            ...
            modelBuilder.Entity("Kolokwium2.Models.CharacterTitle", b =>
                {
                    ...
                    b.HasOne("Kolokwium2.Models.Title", "TitleNavigation")
                        .WithMany("CharacterTitles")
